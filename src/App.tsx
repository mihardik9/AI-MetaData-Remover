      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        <div className="flex justify-center mb-6 sm:mb-8">
          <nav
            ...
            className="inline-flex p-1 rounded-xl bg-neutral-200/80 dark:bg-neutral-800/80 border border-neutral-300/60 dark:border-neutral-700/60 shadow-2xs"
          >
            <button
              type="button"
            ...
            >
              ...
              <span>Image Metadata Remover</span>
            </button>
